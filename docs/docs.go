...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/forgot-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "429": {
                        "description": "requested too soon after the last one",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "DB or mail-provider failure",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    }
        ...
        "/auth/login": {
            "post": {
                "description": "Returns 401 for both \"no such user\" and \"wrong\npassword\" — the same error either way, deliberately,\nso a caller can't use this endpoint to enumerate which\nemails are registered. An unverified account returns\n403 separately, since at that point the password has\nalready confirmed the account exists.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "DB or token-issuing failure",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    }
        ...
        "/auth/logout": {
            "post": {
                "description": "Idempotent — revoking an already-invalid or\nalready-revoked token still returns 200, since from\nthe caller's point of view \"logged out\" is true\neither way.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/auth/refresh": {
            "post": {
                "description": "The presented refresh token is revoked and a brand\nnew pair is issued, even though the request otherwise\nsucceeds — this bounds how long a stolen refresh\ntoken remains useful past the legitimate user's next\nrefresh call.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/auth/resend-otp": {
            "post": {
                "description": "Self-service escape hatch for an account stuck\nmid-verification — used when the original code\nexpired (10 min) or was guessed wrong 3 times. Rate\nlimited to one send per 60 seconds per email so a\ncaller can't hammer the mail provider or the\nrecipient's inbox. The previous code is not\nexplicitly revoked; it simply stops being the\n\"latest\" one once this issues a new one.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "email to resend a code to",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "no account for this email",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
                    "429": {
                        "description": "resend requested too soon after the last one",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
        ...
        "/auth/reset-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "invalid body or OTP incorrect/expired",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
                    "429": {
                        "description": "too many wrong attempts against this code",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
        ...
        "/auth/signup": {
            "post": {
                "description": "Creates a user with email_verified_at = null and sends\na 6-digit OTP to the given email. The account cannot\nlog in until Verify is called with that code.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "missing required field, or password under 8 chars",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "hashing or DB failure",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    }
        ...
        "/auth/verify": {
            "post": {
                "description": "Checks the 6-digit code against the most recent\nunused OTP for this email. On success, marks the\naccount verified and returns a usable token pair —\nthe caller is logged in immediately, no separate\nLogin call needed. Wrong-guess attempts count even on\nfailure; after 3 the code is dead regardless of\nwhether the next guess would've been right.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "no active code, code expired, or code incorrect",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
        ...
        "/v1/tickets": {
            "get": {
                ...
                "description": "Retrieves a paginated list of all betting tickets tracked by the authenticated user.\nThe tickets are ordered by when they were tracked (most recent first).\nProvides high-level details like the total odds and overall ticket status.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.PaginatedHistoryResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized - missing or invalid token",
        ...
        "/v1/tickets/archive": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "List of ticket UUIDs to archive",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.BulkTicketActionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.BulkTicketActionResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request payload or UUID",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
        ...
        "/v1/tickets/archived": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Delta sync timestamp (RFC3339)",
                        "name": "since",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Paginated archived history list",
                        "schema": {
                            "$ref": "#/definitions/model.PaginatedHistoryResponse"
                        }
                    },
        ...
        "/v1/tickets/delete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "List of ticket UUIDs to delete",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/tickets/preview": {
            "post": {
                "description": "Fetches the latest odds and selections for a given booking code\nfrom the specified provider (e.g. SPORTYBET) directly.\nThis does NOT save the ticket to the user's history, it merely\nresolves the code and allows them to preview it before tracking.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Provider name and booking code",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PreviewRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.PreviewResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid provider, missing fields, or invalid code",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "External provider API failure or internal error",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    }
        ...
        "/v1/tickets/track": {
            "post": {
                ...
                "description": "Links a previously previewed ticket (via booking_code_id) to the authenticated user.\nOptionally includes a stake and a description (e.g., \"Weekend acca\").\nOnce tracked, the system will actively poll this ticket for live status updates.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Booking code ID, stake, and optional description",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Ticket successfully tracked",
                        "schema": {
                            "$ref": "#/definitions/MessageResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid booking_code_id or missing fields",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
        ...
        "/v1/tickets/unarchive": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "List of ticket UUIDs to unarchive",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Tickets unarchived successfully",
                        "schema": {
                            "$ref": "#/definitions/model.BulkTicketActionResponse"
                        }
                    },
        ...
        "/v1/tickets/{id}": {
            "get": {
                ...
                "description": "Fetches the deep details of a specific ticket tracked by the user.\nThis includes a breakdown of every single match/selection on the ticket,\nincluding the live status of the matches and the current odds.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "UUID of the tracked user_ticket",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ticket UUID format",
                        "schema": {
                            "$ref": "#/definitions/ErrorResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "description": "Removes the link between the authenticated user and a specific ticket.\nThe underlying booking_code is not immediately deleted so that other users\ntracking the same code are unaffected. A background job later sweeps orphaned codes.",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        "CheckUsernameResponse": {
            ...
            "properties": {
                "available": {
                    "description": "Available is true if the username is not taken.",
                    "type": "boolean",
                    "example": true
                }
            }
        ...
        "ErrorResponse": {
            ...
            "properties": {
                "error": {
                    "description": "Error is a short, user-displayable reason the request failed.",
                    "type": "string"
                }
            }
        },
        ...
        "LoginRequest": {
            ...
            "properties": {
                "email": {
                    "description": "Email is the account's login identifier.",
                    "type": "string",
                    "example": "user@example.com"
                },
                "password": {
                    "description": "Password is the plaintext password to check against the stored hash.",
                    "type": "string",
        ...
        "LogoutRequest": {
            ...
            "properties": {
                "refresh_token": {
                    "description": "RefreshToken is the token to revoke.",
                    "type": "string"
                }
            }
        },
        "MessageResponse": {
            ...
            "properties": {
                "message": {
                    "description": "Message is a human-readable confirmation for the frontend to display.",
                    "type": "string",
                    "example": "logged out"
                }
            }
        ...
        "OAuthLoginRequest": {
            ...
            "properties": {
                "id_token": {
                    "description": "IDToken is the JWT issued by the provider (e.g., Google or Apple).",
                    "type": "string"
                }
            }
        },
        "RefreshRequest": {
            ...
            "properties": {
                "refresh_token": {
                    "description": "RefreshToken is the token issued by a previous login/verify/refresh call.",
                    "type": "string"
                }
            }
        },
        ...
        "ResendOTPRequest": {
            ...
            "properties": {
                "email": {
                    "description": "Email identifies which account to send a fresh code to.",
                    "type": "string",
                    "example": "user@example.com"
                }
            }
        ...
        "SignupRequest": {
            ...
            "properties": {
                "email": {
                    "description": "Email is the account's login identifier. Must be unique.",
                    "type": "string",
                    "example": "user@example.com"
                },
                "password": {
                    "description": "Password is the plaintext password from the client; hashed\nserver-side before storage, never stored or logged as-is.",
                    "type": "string",
                    "example": "correct-horse-battery-staple"
                },
                "username": {
        ...
        "TokenPairResponse": {
            ...
            "properties": {
                "access_token": {
                    "description": "AccessToken is a short-lived (15 min) JWT sent as a Bearer token\non subsequent authenticated requests.",
                    "type": "string"
                },
                "refresh_token": {
                    "description": "RefreshToken is a long-lived (30 day) opaque token used only\nagainst POST /auth/refresh to mint a new pair. It is rotated\n(revoked and replaced) on every use.",
                    "type": "string"
                }
            }
        },
        ...
        "UserProfileResponse": {
            ...
            "properties": {
                ...
                "is_verified": {
                    "description": "IsVerified indicates whether the user has confirmed their email.",
                    "type": "boolean",
                    "example": true
                },
                "username": {
                    "description": "Username is the user's handle. Optional.",
                    "type": "string",
                    "example": "johndoe99"
                }
            }
        ...
        "VerifyRequest": {
            ...
            "properties": {
                "code": {
                    "description": "Code is the 6-digit OTP the user received by email.",
                    "type": "string",
                    "example": "482913"
                },
                "email": {
                    "description": "Email identifies which account's OTP to check.",
                    "type": "string",
                    "example": "user@example.com"
                }
            }
        ...
        "model.BulkTicketActionResponse": {
            "type": "object",
            "properties": {
                "affected": {
                    "type": "integer",
                ...
                "message": {
                    "type": "string",
                    "example": "tickets archived successfully"
                }
            }
        },
        ...
        "model.PreviewResponse": {
            ...
            "properties": {
                ...
                "selections": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.SelectionDetail"
                    }
                },
                "total_odds": {
                    "type": "number"
